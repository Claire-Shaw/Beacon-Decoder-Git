...
def rotating0(bits):
    ...
    ##BIT 5-10 (155-158) Elapsed time since activation (0 to 63 hours in 1 hour steps)
    t_act = Func.bin2dec(bits[5:11])
    rotatingbin.append(['155-158 (Rotating field 5-10)',
                        bits[5:11],
    ...
    rotatingbin.append(['159-164 (Rotating field 11-21)',
                        bits[11:22],
